...
function Footer() {
  return (
      ...
      <div className="footer-contents d-flex justify-content-evenly align-items-center w-100 mt-5">
        <div className="website-details " style={{width:"25%"}} sm={2} md={4}>
            {/* <div className='d-flex flex-row align-items-center' > */}
                ...
                <h4 className='text-light fw-bold align-middle text-center fs-2'> <i class="fa-solid fa-mug-saucer me-3 fa-beat"></i>Cafe De Latte</h4>
            {/* </div> */}
                {/* <div> */}
      ...
      <p className='text-light mb-5 mt-3' style={{fontSize:'13px'}}>Copyright © 2023 CafeDeLatte.  <span>Built with React</span></p>
    </div>
  )
}
